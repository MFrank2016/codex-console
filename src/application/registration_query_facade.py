    ...
    def _current_day_intersection_count(
        ...
        *,
        ...
        today_filters = RegistrationFailureQuery(
            ...
            failure_stage=filters.failure_stage,
            step_key=filters.step_key,
    ...
    def build_failure_summary(
        ...
        *,
        ...
        return RegistrationFailureSummaryView(
            ...
            top_failure_stages=list(summary.get("top_failure_stages", [])),
            top_step_keys=list(summary.get("top_step_keys", [])),
            retryable_breakdown=list(summary.get("retryable_breakdown", [])),
        )
