...
def build_current_pipeline_definition() -> PipelineDefinition:
    return PipelineDefinition(
        ...
        steps=[
            ...
            _step_with_transient_retry("init_auth_session", current_init_auth_session_step, impl_key="current.init_auth_session"),
            _step_with_transient_retry("prepare_authorize_flow", current_prepare_authorize_flow_step, impl_key="current.prepare_authorize_flow"),
            _step_with_transient_retry("submit_signup_email", current_submit_signup_email_step, impl_key="current.submit_signup_email"),
            ...
            _step_with_transient_retry("submit_login_email", current_submit_login_email_step, impl_key="current.submit_login_email"),
            _step_with_transient_retry("submit_login_password", current_submit_login_password_step, impl_key="current.submit_login_password"),
